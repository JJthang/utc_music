    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          className="w-full bg-black border border-gray-600 text-white placeholder-gray-500 px-4 py-3 rounded-lg focus:outline-none focus:border-white focus:ring-0"
        />
      </div>
      <div>
...
function OAuthButton({ icon, label }: OAuthButtonProps) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="w-full flex items-center justify-center gap-3 border border-gray-600 text-white font-bold py-3 rounded-full hover:border-white transition"
    >
      {getIcon()}
      {label}
    </button>
